  ...
  return (
    <>
      <Container>
        ...
        <div className="containerCards">
          <div className="cards">
            ...
            <p>
              Acesso facil para nosso hotel com uma vista panoramica de todo o
              ambiente
            </p>
          </div>
      ...
      <ContainerImg>
        <h1>
          {' '}
          <span>NOSSO HOTEL OFERECE OS MELHORES SERVIÇOS</span> PARA VOCÊ
          DESFRUTAR DE UMA ESTADIA TRANQUILA
        </h1>
      </ContainerImg>
      ...
      <ContainerHotel>
        <p>
          {' '}
          <span>
            consectetur adipisicing elit. Sapiente, expedita totam doloribus hic
            molestias vero quas excepturi perspiciatis veniam earum natus nisi
            laborum est autem, blanditiis dolores dolorem magni voluptate.
          </span>
        </p>
        ...
        <p>
          ...
          vero quas excepturi perspiciatis veniam earum natus nisi laborum est
          autem, blanditiis dolores dolorem magni voluptate.
        </p>
        <div>
          <img src={piscina3} alt="" />
